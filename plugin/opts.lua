...
vim.opt.guicursor         = 'n-sm:block-Cursor,i:ver30-iCursor,v:block-vCursor,r-c:block-cCursor,o:block-oCursor'
...
vim.g.undotree_DiffCommand = "FC" -- Make undotree work on linux?
--
-- windows
